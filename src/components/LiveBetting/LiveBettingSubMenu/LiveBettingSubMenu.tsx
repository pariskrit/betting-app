      ...
      <div className="flex justify-end items-center flex-1 gap-1 pl-2 overflow-hidden">
        {submenuTabs.map((item: any, idx: number) => (
          <LiveBettingIconButton
            id={idx}
            key={idx}
            className={`relative justify-center items-center min-w-[60px] text-textWhite-300/70 hover:text-white text-[13px] w-auto ${
              item.isActive ? "text-white font-bold" : "font-normal"
            }`}
          >
            <span
